...
int main()
{
    ...
    selectionSort(kids, 12); // selection sort

    string vehicles[4][4] = { {"White Van", "Green Bus", "Blue SUV", "Red Racecar"},
                            {"Grey Car", "Cube Car", "Black car", "Fire Truck"},
                            {"Plane", "Black SUV", "Yellow Truck", "Blue Jeep"},
    ...
    cout << "Auntie Your Sprite is in the cooler!" << endl;
    cout << "Uncle Your Coke is in the cooler!" << endl;

    // new

    cout << endl;

    string auntieBeverage, uncleBeverage;

    try
    {
        cout << "Auntie, I hear you would like an extra beverage! Enter what you would like: ";
        getline(cin, auntieBeverage);

        if (auntieBeverage == "Bud Light")
            throw string("Error: You can't have a Bud Light.");

        cout << "Coming right up!" << endl;
    }
    catch (string x)
    {
        cout << x << " You are only " << AuntieAge << "!" << endl;
    }

    cout << endl;

    cout << "Uncle, I hear you would like an extra beverage! Enter what you would like: ";
    cin >> uncleBeverage;
    cout << "Coming right up!" << endl;
